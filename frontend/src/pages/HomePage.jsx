        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="space-y-6 md:space-y-8">
            ...
            <div className="stats stats-vertical sm:stats-horizontal bg-base-100 shadow-lg w-full">
              <div className="stat">
                <div className="stat-value text-primary text-2xl md:text-3xl">10K+</div>
                <div className="stat-title text-xs md:text-sm">Active Users</div>
              </div>
              <div className="stat">
                <div className="stat-value text-secondary text-2xl md:text-3xl">50K+</div>
                <div className="stat-title text-xs md:text-sm">Sessions</div>
              </div>
              <div className="stat">
                <div className="stat-value text-accent text-2xl md:text-3xl">99.9%</div>
                <div className="stat-title text-xs md:text-sm">Uptime</div>
              </div>
            </div>
          </div>
          ...
          <img
            ...
            className="w-full h-auto rounded-3xl shadow-2xl border-4 border-base-100 hover:scale-105 transition-transform duration-500 order-first lg:order-last"
          />
        </div>
      </div>
